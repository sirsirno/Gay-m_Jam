...
public class SkillUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        if (property.Equals(Property.FIRE)) tab.propertyText.text = "<color=#ff0000>불 속성</color>";
        else if (property.Equals(Property.WATER)) tab.propertyText.text = "<color=#0000ff>물 속성</color>";
